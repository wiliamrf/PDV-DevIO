...
IF NOT EXISTS (
    ...
    WHERE [MigrationId] = N'20240330004106_Initial'
)
BEGIN
...
BEGIN
    ...
    VALUES (N'20240330004106_Initial', N'8.0.3');
END;
GO
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20240330021712_RevisaoProduto'
)
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20240330021712_RevisaoProduto', N'8.0.3');
END;
GO
